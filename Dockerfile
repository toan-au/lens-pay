...
# docker build -t lens_pay .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name lens_pay lens_pay
...
# Install JS dependencies (cached layer before app code copy)
